...
public class TrainerAddClient extends AppCompatActivity {
    ...
    EditText trainerObjectivesEditText;
    EditText dayPerWeekInputTrainerEditText;
    String clientID;
    String trainerObjectives;
    String daysPerWeek;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trainerObjectivesEditText = (EditText) findViewById(R.id.trainerObjectives);
        dayPerWeekInputTrainerEditText = (EditText) findViewById(R.id.dayPerWeekInputTrainer);
    }

    public void trainerRegisterClient(View view) {
        clientID =clientID_EditText.getText().toString() ;
        trainerObjectives = trainerObjectivesEditText.getText().toString();
        daysPerWeek = dayPerWeekInputTrainerEditText.getText().toString();

        if (clientID.equalsIgnoreCase("") || trainerObjectives.equalsIgnoreCase("") || daysPerWeek.equalsIgnoreCase("")) {
    ...
    class registerClientAPI extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            BasicNameValuePair daysPerWeekParam = new BasicNameValuePair("dayPerWeek", daysPerWeek);
            BasicNameValuePair trainerObjectiveParam = new BasicNameValuePair("objective", trainerObjectives);

            ArrayList<NameValuePair> name_value_pair_list = new ArrayList<>();
            name_value_pair_list.add(clientIDParam);
            name_value_pair_list.add(trainerUsernameParam);
            name_value_pair_list.add(daysPerWeekParam);
            name_value_pair_list.add(trainerObjectiveParam);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                if(s.equalsIgnoreCase("client registered successfully!")){
                    ...
                    dayPerWeekInputTrainerEditText.setText("");
                    trainerObjectivesEditText.setText("");
                    toastMessage(s).show();
                }
                else{
                    toastMessage(s).show();
